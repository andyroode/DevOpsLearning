...
test_data = [
    ...
    , ("project-ocp-mdc-09", "cse-toolset", "mdc-09-cse-toolset-from-tests")
    , ("cloud-without-passport", "env-without-passport", "env-without-passport-version-from-tests")
    , ("project-sb-ocp-01", "pl01", "project-sb-ocp-01-pl01-version-from-tests")
    , ("project-sb-ocp-01", "platform-with-overrides", "project-sb-ocp-01-platform-with-overrides-version-from-tests")
