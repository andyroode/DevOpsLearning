def call (Map config = [:]){
	...
	ansiblePlaybook installation: 'Ansible', inventory: 'Ansible_for_Jenkins/hosts', playbook: 'Ansible_for_Jenkins/InstallPostgres13.yml', vaultCredentialsId: 'Ansible secret password'
}
